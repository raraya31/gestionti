# Mise en œuvre de confidentialité — gestionti.info

**Date :** 17 septembre 2026
**Portée :** site public Gestion TI Informatique et ses parcours de contact en ligne
...
Des en-têtes de sécurité sont ajoutés dans le document HTML. Ils limitent les scripts, polices, images et connexions aux sources strictement nécessaires. Formspree est la seule connexion externe autorisée depuis le formulaire. La page de politique explique également le recours volontaire à Microsoft Bookings lorsque le visiteur sélectionne ce lien.

## Flux de renseignements déclarés

| Parcours | Renseignements | Service et finalité |
|---|---|---|
| Formulaire de consultation | Nom, téléphone, courriel, entreprise et message | Formspree reçoit ces renseignements pour les acheminer à Gestion TI Informatique afin de traiter la demande et d’effectuer le suivi. |
| Réservation volontaire | Renseignements saisis par le visiteur dans la page de réservation | Microsoft Bookings organise la consultation lorsque le visiteur choisit d’ouvrir ce service. |
...
[1]: https://www.cai.gouv.qc.ca/uploads/pdfs/CAI_GU_POL_Confidentialite.pdf "Rédiger une politique de confidentialité — guide explicatif pour les entreprises"
[2]: https://www.cai.gouv.qc.ca/uploads/pdfs/CAI_GU_EFVP.pdf "Réaliser une évaluation des facteurs relatifs à la vie privée — guide d’accompagnement"
[3]: https://www.cai.gouv.qc.ca/protection-renseignements-personnels/citoyens-protection-renseignements-personnels/acces-et-protection-renseignements-personnels "Vos droits — Commission d’accès à l’information du Québec"
